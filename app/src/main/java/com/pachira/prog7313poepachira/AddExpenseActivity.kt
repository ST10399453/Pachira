...
class AddExpenseActivity : AppCompatActivity() {
    ...
    // Add this variable to track available balance
    private var availableBalance = 0.0

    // Add these variables near the top of the class with other variables
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Add this code to handle image selection
    ...
    private fun saveExpense() {
        ...
        if (amount > availableBalance) {
            Toast.makeText(this, "Insufficient funds. Available balance: ${formatCurrency(availableBalance)}", Toast.LENGTH_LONG).show()
            return
        }
